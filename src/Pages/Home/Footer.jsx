      ...
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.github.com/hikmahnurarifah"
              ...
              >
                ...
                >
                  <path
                    d="M12 0C5.373 0 0 5.373 0 12c0 5.303 3.438 9.8 8.207 11.387.6.111.793-.261.793-.578 0-.286-.01-1.24-.015-2.25-3.338.725-4.042-1.611-4.042-1.611C4.207 17.433 3.64 16.8 3.64 16.8c-1.087-.744.083-.729.083-.729 1.205.084 1.838 1.24 1.838 1.24 1.07 1.832 2.809 1.304 3.495.997.108-.776.417-1.304.76-1.604-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.384 1.235-3.224-.125-.3-.54-1.523.12-3.176 0 0 1.008-.322 3.3 1.23.958-.266 1.982-.398 3-.404 1.018.006 2.042.138 3 .404 2.29-1.552 3.297-1.23 3.297-1.23.66 1.653.245 2.876.12 3.176.77.84 1.234 1.914 1.234 3.224 0 4.609-2.804 5.626-5.477 5.922.43.369.817 1.096.817 2.213 0 1.599-.015 2.882-.015 3.275 0 .318.192.694.8.576C20.562 21.798 24 16.303 24 12c0-6.627-5.373-12-12-12"
                    fill="white"
                  />
                </svg>
              </a>
            ...
            <li>
              <a
                href="https://www.instagram.com/nurarifahikmah"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.twitter.com/molefts"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/hikmah-nurarifah/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
